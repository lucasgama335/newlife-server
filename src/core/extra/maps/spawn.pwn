...
hook OnGameModeInit()
{
	//=====================================[ 3DTEXT ]====================================||
	// Faq Spawn Civil LS
	Create3DTextLabel("{00e7c6}AJUDA PARA NOVATOS\n{FFFFFF}Aperte '{00e7c6}F{FFFFFF}'\n{FFFFFF}Em caso de dúvidas ou use o {00e7c6}/faq{FFFFFF}.", COLOR_CYAN, 809.5279,-1341.4880,13.5405, 20.0,0);

	//=====================================[ 3DTEXT ]====================================||
	AddStaticPickup(18749, 23, 809.5279,-1341.4880,13.5405); // Faq Civil
    ...
    //=====================================[ ACTORS ]====================================||
    spawnActor[0] = CreateActor(211, 808.8286,-1341.5260,13.5417,265.2473);
    ApplyActorAnimation(spawnActor[0], "PED", "IDLE_CHAT", 4.1, 1, 0, 0, 0, 0);
	spawnActor[1] = CreateActor(11, 815.7498,-1355.5166,13.5414,357.1111);
	spawnActor[2] = CreateActor(189, 811.8927,-1355.5170,13.5414,0.5015);
    return 1;
}
